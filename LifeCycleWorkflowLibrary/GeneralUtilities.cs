...
namespace LifeCycleWorkflowLibrary
{
    public static class GeneralUtilities
    {
        ...
        public static void BackupSettings()
        {
            ...
            string destination = Path.GetDirectoryName(Assembly.GetExecutingAssembly().Location) + "\\..\\userLastVersion.config";
        ...
        public static void RestoreSettings()
        {
            ...
            string sourceFile = Path.GetDirectoryName(Assembly.GetExecutingAssembly().Location) + "\\..\\userLastVersion.config";
